...
<!--
  ...
  Izlazne klase (@rdf_export_classes) su violates_* relacije + min/max_imprisonment.

  Koristi se za rulebase.ruleml; ekvivalent je
  app/src/main/resources/dr-device/lrml2ruleml_environmental.xsl koji aplikacija
  ucitava pri radu (DrDeviceReasoner).
-->
